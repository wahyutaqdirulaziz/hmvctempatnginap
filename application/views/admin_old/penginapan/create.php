				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="<?= base_url('penginapan') ?>">Penginapan</a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
							...
							<?= form_open_multipart();?>
								<div class="card">
									...
									<div class="card-action text-right">
										<a href="<?= base_url('penginapan') ?>" class="btn btn-danger">Batal</a>
		...
		<?php
			if(isset($data->latitude)){
				if($data->latitude != ''){
					...
					$defaultLong = $data->longitude;
				} else {
					$defaultLat = '-2';
					$defaultLong = '119';
				}
			}
			else if(set_value('latitude'))
			{
				$defaultLat = set_value('latitude');
				$defaultLong = set_value('longitude');
			} else {
				$defaultLat = '-2';
				$defaultLong = '119';
			}
