							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<a href="<?= admin_url('menu/create') ?>" class="btn btn-primary btn-round ml-auto">
												...
												<?php
													...
													foreach ($menus as $menu) {
														echo '<tr>
																...
																<td>
																	<form method="post" id="form-delete-'. $menu->id. '" action="'.admin_url('menu/delete/'.$menu->id).'">
																		<input type="hidden" name="'.$this->security->get_csrf_token_name().'" value="'.$this->security->get_csrf_hash().'">
																		<input type="hidden" name="id" value="'. $menu->id. '"/>
																	</form>
																	<div class="btn-group" role="group" aria-label="Basic example">
																		<a href="'.admin_url('menu/edit/'.$menu->id).'" type="button" data-toggle="tooltip" title="" class="btn btn-primary btn-sm" data-original-title="Edit">
