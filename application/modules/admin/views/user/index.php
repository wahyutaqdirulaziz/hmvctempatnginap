							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<a href="<?= admin_url('user/create') ?>" class="btn btn-primary btn-round ml-auto">
												...
												<?php
													...
													foreach ($penggunas as $user) {
														...
														echo '<tr>
																...
																<td>
																	<form method="post" id="form-delete-'. $user->id. '" action="'.admin_url('user/delete/'.$user->id).'">
																		<input type="hidden" name="'.$this->security->get_csrf_token_name().'" value="'.$this->security->get_csrf_hash().'">
																		<input type="hidden" name="id" value="'. $user->id. '"/>
																	</form>
																	<div class="btn-group" user="group" aria-label="Basic example">
																		<a href="'.admin_url('user/edit/'.$user->id).'" type="button" data-toggle="tooltip" title="" class="btn btn-primary btn-sm" data-original-title="Edit">
