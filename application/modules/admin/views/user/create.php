...
<body>
				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="<?= admin_url('user') ?>">Pengguna</a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
							...
							<?= form_open_multipart();?>
								<div class="card">
									...
									<div class="card-action text-right">
										<a href="<?= admin_url('user') ?>" class="btn btn-danger">Batal</a>
	...
	<script>
		...
		function readURL(input) {
			...
			// else if(!url)
			// {
			// 	$('.imagepreview').attr('src', '<?= admin_url('assets/admin-template/images/add-image.jpg') ?>');
			// }
