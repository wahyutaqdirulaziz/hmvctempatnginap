							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<a href="<?= admin_url('kategori-penginapan/create') ?>" class="btn btn-primary btn-round ml-auto">
												...
												<?php
													...
													foreach ($kategori_penginapans as $kp) {
														echo '<tr>
																...
																<td>
																	<form method="post" id="form-delete-'. $kp->id_kategori_kamar. '" action="'.admin_url('kategori-penginapan/delete/'.$kp->id_kategori_kamar).'">
																	...
																	<div class="btn-group" kategori-penginapan="group" aria-label="Basic example">
																		<a href="'.admin_url('kategori-penginapan/edit/'.$kp->id_kategori_kamar).'" type="button" data-toggle="tooltip" title="" class="btn btn-primary btn-sm" data-original-title="Edit">
