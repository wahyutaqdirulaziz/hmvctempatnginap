							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<a href="<?= admin_url('member/create') ?>" class="btn btn-primary btn-round ml-auto">
												...
												<?php
													...
													foreach ($members as $member) {
														echo '<tr>
																...
																<td>
																	<form method="post" id="form-delete-'. $member->id_member. '" action="'.admin_url('member/delete/'.$member->id_member).'">
																		<input type="hidden" name="'.$this->security->get_csrf_token_name().'" value="'.$this->security->get_csrf_hash().'">
																		<input type="hidden" name="id_member" value="'. $member->id_member. '"/>
																	</form>
																	<div class="btn-group" role="group" aria-label="Basic example">
																		<a href="'.admin_url('member/edit/'.$member->id_member).'" type="button" data-toggle="tooltip" title="" class="btn btn-primary btn-sm" data-original-title="Edit">
