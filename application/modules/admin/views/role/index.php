							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<a href="<?= admin_url('role/create') ?>" class="btn btn-primary btn-round ml-auto">
												...
												<?php
													...
													foreach ($roles as $role) {
														...
														echo '<tr>
																...
																<td>'.$status.'</td>
																<td>
																	<form method="post" id="form-delete-'. $role->id. '" action="'.admin_url('role/delete/'.$role->id).'">
																		<input type="hidden" name="'.$this->security->get_csrf_token_name().'" value="'.$this->security->get_csrf_hash().'">
																		<input type="hidden" name="id" value="'. $role->id. '"/>
																	</form>
																	<div class="btn-group" role="group" aria-label="Basic example">
																		<a href="'.admin_url('role/edit/'.$role->id).'" type="button" data-toggle="tooltip" title="" class="btn btn-primary btn-sm" data-original-title="Edit">
