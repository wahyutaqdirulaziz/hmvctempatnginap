							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<a href="<?= admin_url('penginapan/create') ?>" class="btn btn-primary btn-round ml-auto">
													...
													foreach ($penginapans as $penginapan) {
														...
														if($this->auth->roles()[0] == 2){
															echo '<tr>
																...
																<td>
																	<form method="post" id="form-delete-'. $penginapan->id_kamar. '" action="'.admin_url('penginapan/delete/'.$penginapan->id_kamar).'">
																		<input type="hidden" name="id_kamar" value="'. $penginapan->id_kamar. '"/>
																	</form>
																	<div class="btn-group" role="group" aria-label="Basic example">
																		<a href="'.admin_url('penginapan/edit/'.$penginapan->id_kamar).'" type="button" data-toggle="tooltip" title="" class="btn btn-primary btn-sm" data-original-title="Edit">
